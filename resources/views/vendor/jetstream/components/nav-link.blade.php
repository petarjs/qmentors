...
<a {{ $attributes }} class="
@if($active)
    inline-flex items-center px-1 pt-1 border-b-2 border-green-400 text-sm font-medium leading-5 text-gray-900 focus:outline-none focus:border-gren-700 transition
@else
